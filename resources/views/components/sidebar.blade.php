...
<aside id="sidebar"
    ...
    <nav class="flex-1 overflow-y-auto px-4 py-5">
        ...
        {{-- Admin Section --}}
        @auth
            <p class="px-3 mt-5 mb-3 text-xs font-semibold text-white/40 uppercase tracking-widest">Admin</p>

            <a href="{{ route('admin.payment-report') }}"
                class="flex items-center gap-3 px-3 py-2.5 mb-1 rounded-xl text-sm font-medium transition-all duration-200 {{ $activeSlug === 'admin' ? 'bg-white/15 text-white shadow-lg shadow-black/10' : 'text-white/70 hover:bg-white/10 hover:text-white' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
